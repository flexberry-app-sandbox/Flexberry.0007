...
namespace IIS.0007
{
    ...
    public class Настройки : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.0007.ТипНастр fТипНастроек;
        ...
        /// Описание.
        /// </summary>
        // *** Start programmer edit section *** (Настройки.Описание CustomAttributes)

        // *** End programmer edit section *** (Настройки.Описание CustomAttributes)
        [StrLen(255)]
        public virtual string Описание
        {
            get
            {
                // *** Start programmer edit section *** (Настройки.Описание Get start)

                // *** End programmer edit section *** (Настройки.Описание Get start)
                string result = this.fОписание;
                // *** Start programmer edit section *** (Настройки.Описание Get end)

                // *** End programmer edit section *** (Настройки.Описание Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Настройки.Описание Set start)

                // *** End programmer edit section *** (Настройки.Описание Set start)
                this.fОписание = value;
                // *** Start programmer edit section *** (Настройки.Описание Set end)

                // *** End programmer edit section *** (Настройки.Описание Set end)
            }
        }
        ...
        public virtual IIS.0007.ТипНастр ТипНастроек
        {
            get
            {
                ...
                IIS.0007.ТипНастр result = this.fТипНастроек;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.0007.Сервер.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View НастройкиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НастройкиE", typeof(IIS.0007.Настройки));
                }
            }
        }
    }
    ...
    public class DetailArrayOfНастройки : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.0007.DetailArrayOfНастройки members)

        // *** End programmer edit section *** (IIS.0007.DetailArrayOfНастройки members)
        ...
        /// </summary>
        public DetailArrayOfНастройки(IIS.0007.Сервер fСервер) : 
                base(typeof(Настройки), ((ICSSoft.STORMNET.DataObject)(fСервер)))
        {
        }
        
        public IIS.0007.Настройки this[int index]
        {
            get
            {
                return ((IIS.0007.Настройки)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.0007.Настройки dataobject)
        {
