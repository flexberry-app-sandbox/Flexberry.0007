...
namespace IIS.0007
{
    ...
    public class Сотрудник : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.0007.Должность fДолжность;
        ...
        /// IdСотрудник.
        /// </summary>
        // *** Start programmer edit section *** (Сотрудник.IdСотрудник CustomAttributes)

        // *** End programmer edit section *** (Сотрудник.IdСотрудник CustomAttributes)
        public virtual int IdСотрудник
        {
            get
            {
                // *** Start programmer edit section *** (Сотрудник.IdСотрудник Get start)

                // *** End programmer edit section *** (Сотрудник.IdСотрудник Get start)
                int result = this.fIdСотрудник;
                // *** Start programmer edit section *** (Сотрудник.IdСотрудник Get end)

                // *** End programmer edit section *** (Сотрудник.IdСотрудник Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Сотрудник.IdСотрудник Set start)

                // *** End programmer edit section *** (Сотрудник.IdСотрудник Set start)
                this.fIdСотрудник = value;
                // *** Start programmer edit section *** (Сотрудник.IdСотрудник Set end)

                // *** End programmer edit section *** (Сотрудник.IdСотрудник Set end)
            }
        }
        ...
        [PropertyStorage(new string[] {
                "Должность"})]
        [NotNull()]
        public virtual IIS.0007.Должность Должность
        {
            get
            {
                ...
                IIS.0007.Должность result = this.fДолжность;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СотрудникE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникE", typeof(IIS.0007.Сотрудник));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СотрудникL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СотрудникL", typeof(IIS.0007.Сотрудник));
                }
            }
        }
    }
